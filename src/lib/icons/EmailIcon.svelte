<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	/>
	<path d="M18 8L15.8411 9.79908C14.0045 11.3296 13.0861 12.0949 12 12.0949C11.3507 12.0949 10.7614 11.8214 10 11.2744M6 8L6.9 8.75L7.8 9.5" stroke="var(--text-color)" stroke-width="1.5" stroke-linecap="round" />
</svg>
